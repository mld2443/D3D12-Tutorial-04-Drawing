...
EngineClass::EngineClass(HWND hwnd, UINT xResolution, UINT yResolution, bool fullscreen) :
	...
	m_Pipeline(make_unique<SoloPipelineClass>(m_Direct3D->GetDevice(), xResolution, yResolution, m_Camera->GetScreenNear(), m_Camera->GetScreenFar())),
...
void EngineClass::Render()
{
	...
	m_Pipeline->SetPipelineParameters(
